  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <StaggerGroup className="mx-auto flex max-w-5xl flex-wrap justify-center gap-6">
          {impactStats.map((stat) => (
            ...
            >
              <div className="flex w-full flex-col items-center rounded-2xl border border-border bg-card px-6 py-8 text-center shadow-sm">
