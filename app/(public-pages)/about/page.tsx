      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="mx-auto grid max-w-6xl items-start gap-12 lg:grid-cols-2">
          ...
          <ScrollReveal direction="right">
            ...
            <StaggerGroup as="ul" className="mt-8 space-y-4">
              {checklist.map((item) => (
          ...
          {/* Right: founder photo */}
          <ScrollReveal direction="left" delay={0.15} className="flex flex-col items-center lg:items-end">
            <HoverLift className="w-full max-w-sm" scale={1.02} lift={4}>
              <div className="w-full overflow-hidden rounded-2xl border border-[#C9A96A]/30 bg-card p-2 shadow-sm">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Button
              asChild
              variant="outline"
              className="h-14 rounded-full border-[#C9A96A]/40 bg-transparent px-8 text-white transition-transform hover:scale-105 hover:bg-white/10"
            >
