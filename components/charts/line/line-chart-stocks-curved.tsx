...
const companyLogos = [
  <g key={0}>
    <path fill="currentColor" className="text-[#C9A96A]" d="M0 0h18v18H0V0Z" />
    <path
      fill="#fff"
  ...
  <g key={1}>
    <path fill="currentColor" className="text-[#B8935A]" d="M0 0h18v18H0V0Z" />
    <path
      fill="#fff"
  ...
  <g key={2}>
    <path fill="#0A0A0A" d="M0 0h18v18H0V0Z" />
    <path
      fill="#F6F8FD"
  ...
  <g key={3}>
    <g>
      <path fill="#C9C0B4" d="M0 0h18v18H0V0Z" />
      <path
        fill="#fff"
  ...
  <g key={4}>
    <path fill="currentColor" className="text-[#EDE0C8]" d="M0 0h18v18H0V0Z" />
    <path
      fill="#fff"
      fillRule="evenodd"
  ...
  <g key={5}>
    <g className="group is-published">
      ...
      <path fill="#B8935A" d="M0 0h18v18H0V0Z" />
      <path
        fill="#EDE0C8"
