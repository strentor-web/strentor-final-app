  ...
  const calculators = [
    {
      ...
      icon: <Scale className="h-8 w-8 text-[#C9A96A]" />,
      color: "bg-[#C9A96A]/10",
    },
    {
      id: "calorie",
      ...
      icon: <Utensils className="h-8 w-8 text-[#B8935A]" />,
      color: "bg-[#B8935A]/10",
    },
    {
      id: "body-fat",
      ...
      icon: <Activity className="h-8 w-8 text-[#8a8072]" />,
      color: "bg-[#C9C0B4]/20",
    },
    {
      id: "bmr",
      ...
      icon: <Flame className="h-8 w-8 text-[#8a6d3b]" />,
      color: "bg-[#EDE0C8]/30",
    },
    {
      id: "ideal-weight",
    ...
    },
    {
      ...
      icon: <Activity className="h-8 w-8 text-[#B8935A]" />,
      color: "bg-[#B8935A]/10",
    },
    {
      id: "healthy-weight",
      ...
      icon: <Heart className="h-8 w-8 text-[#8a8072]" />,
      color: "bg-[#C9C0B4]/20",
    },
    {
      id: "calories-burned",
    ...
    },
    {
      ...
      icon: <Dumbbell className="h-8 w-8 text-[#C9A96A]" />,
      color: "bg-[#C9A96A]/10",
    },
    {
      id: "macro",
      ...
      icon: <PieChart className="h-8 w-8 text-[#B8935A]" />,
      color: "bg-[#B8935A]/10",
    },
    {
      id: "body-type",
